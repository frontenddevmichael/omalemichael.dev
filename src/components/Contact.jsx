        ...
        <div className="section-grid">
          ...
          <div className="section-body contact-section">
            ...
            <div className="contact-stack">
              <a href={LINKS.githubUrl} className="clink-card stagger-up" data-i="1" target="_blank" rel="noopener noreferrer" aria-label="GitHub profile — opens in new tab">
              ...
              <a href={LINKS.linkedinUrl} className="clink-card stagger-up" data-i="2" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile — opens in new tab">
              ...
              <a href={`mailto:${LINKS.email}`} className="clink-card stagger-up" data-i="3" aria-label="Send email">
              ...
              <a href={LINKS.whatsapp} className="clink-card stagger-up" data-i="4" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp — opens in new tab">
